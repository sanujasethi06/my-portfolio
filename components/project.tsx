...
function Project({ title, description, tags, imageUrl }: ProjectProps) {
    ...
    style={{
     scale: scaleProgress,
        ...
        className="group"
    ><section 
        className=' bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 group-even:pl-8 rounded-lg hover:bg-gray-200 transition'>
